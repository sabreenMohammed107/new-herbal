...
<div class="white-background content-details">                        
    ...
    <div class="p-3"  >
        <div class="row justify-content-end mb-4">
            ...
            <div class="col-md-3">
                <input type="text" name="search" class="form-control" id="certification_search" placeholder="{{Lang::get('headings.Search')}}">
            </div>
        </div>
        <div class="seacrch_certification_contrent"></div>
