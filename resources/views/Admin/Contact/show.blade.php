...
<div class="white-background mt-4 content-details">                        
    <div class="content-header white-text">
        <h4 class="p-3 f16 f400 reversible-text"> 
            {{ Lang::get('headings.AssignContactValues')}}
        </h4>
        <div class="clearfix"></div>
    </div>
    <div class="p-3  reversible-form"  >
        ...
        <div class="row form-group mb-4">
            <div class="col-md-12" >
                <div class="table-responsive text-center">
                    <table class="table table-bordered contact-prerequist">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <textarea class="form-control" rows="3" disabled="">{{$contactValue->arabic_value}}</textarea>
                                </td>  
                                <td>
                                    <textarea class="form-control" rows="3" disabled="">{{$contactValue->english_value}}</textarea>
                                </td>  
                                <td>
                                    @if($contactValue->active ==1)
                                    <i class="fa fa-check-circle active-item" aria-hidden="true"></i>
                                    @elseif ($contactValue->active ==0)
                                    <i class="fa fa-times red-text" aria-hidden="true"></i>
                                    @endif

                                </td>
                                <td>
                                    <i class="fa fa-pencil edit" aria-hidden="true"  title="edit" data-toggle="modal" data-target="#contentEditModal{{$contactValue->id}}">
                                    </i>
                                </td>  
                                <td>
        ...
        @foreach ($contact->contactValues as $contactValue)
        <div class="modal fade" id="DeleteModal{{$contactValue->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body"> 
                        ...
                        <div class="modal-footer border-none">
                            {{ csrf_field()}}
                            <button data-id="{{$contactValue->id}}" type="button"  class="btn actionBtn btn-danger contact-value-delete delete-button" data-dismiss="modal">
        ...
        @endforeach
        @foreach ($contact->contactValues as $contactValue)
        <div class="modal fade" id="contentEditModal{{$contactValue->id}}" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    {!! Form::open(['action'=>'ContactController@assignContactValueUpdate']) !!}
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <input type="hidden" name="id" value="{{$contactValue->id }}">
                        ...
                        <div class="row form-group mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <textarea class="form-control" name="arabic_value" id="arabic_value" rows="3" required="">{{$contactValue->arabic_value}}</textarea>
                                </div>
                            </div>
                            <div class="col-md-3 reversible-text text-left  pl-4">
                            ...
                            <div class="col-md-3">
                                <div class="input-group">
                                    <textarea class="form-control" name="english_value" id="english_value" rows="3" required="">{{$contactValue->english_value}}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row form-group mb-4">
        ...
        <div class="row form-group mb-4">
            <div class="col-md-11 mt-3 reversible-text" >
                <a class="red-button btn  pointer white-text" href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),"assignContactValue/{$contact->id}") }}">
                    {{Lang::get('labels.add')}}
                </a>
            </div>
