...
<div  class="button-header mb-4 white-background p-3">
    <div class="row">
        <div class="col-md-12 reversible-text">                                
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),"productCategory/") }}" class="red-button btn  pointer white-text ">
...
<div class="white-background content-details">                        
    ...
    <div class="p-3 mt-3 reversible-form"  >
        {!! Form::open(['action'=>'ProductCategoryController@store','id'=>'productCategory-form','enctype'=>'multipart/form-data']) !!}
