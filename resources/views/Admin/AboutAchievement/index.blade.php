...
<div  class="button-header mb-4 white-background p-3">
    <div class="row">
        <div class="col-md-12 reversible-text">                                
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),"aboutAchievement/create") }}" class="red-button btn  pointer white-text"> 
...
<div class="white-background content-details">                        
    <div class="content-header white-text">
        <h4 class="p-3 f16 f400 reversible-text"> {{Lang::get('headings.aboutAchievements')}} </h4>
    ...
    <div class="p-3"  >
        <div class="row justify-content-end mb-4">
            ...
            <div class="col-md-3">
                <input type="text" name="search" class="form-control" id="aboutAchievements_search" placeholder="{{Lang::get('headings.Search')}}">
            </div>
        </div>
        <div class="seacrch_aboutAchievements_contrent"></div>
