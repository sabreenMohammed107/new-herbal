...
<div  class="button-header mb-4 white-background p-3">
    <div class="row">
        <div class="col-md-12 reversible-text">                                
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),"galleryType/create") }}" class="red-button btn  pointer white-text"> 
                {{ Lang::get('headings.NewGalleryType')}}
            </a>
        </div>
    </div>
</div>
<div class="white-background content-details">                        
    <div class="content-header white-text">
        <h4 class="p-3 f16 f400 reversible-text"> {{Lang::get('headings.galleryTypes')}} </h4>
    ...
    <div class="p-3"  >
        <div class="row justify-content-end mb-4">
            ...
            <div class="col-md-3">
                <input type="text" name="search" class="form-control" id="gallery_type_search" placeholder="{{Lang::get('headings.Search')}}">
            </div>
        </div>
        <div class="seacrch_gallery_type_contrent"></div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body"> 
                                        ...
                                        <div class="modal-footer border-none">
                                            {{ csrf_field()}}
                                            <button data-id="{{$gallery_type->id}}" type="button"  class="btn actionBtn btn-danger gallery_type-delete add-button" data-dismiss="modal">
