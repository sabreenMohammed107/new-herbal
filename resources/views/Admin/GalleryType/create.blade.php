...
<div  class="button-header mb-4 white-background p-3">
    <div class="row">
        <div class="col-md-12 reversible-text">                                
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),"galleryType/") }}" class="red-button btn  pointer white-text ">
...
<div class="white-background content-details">                        
    ...
    <div class="p-3 mt-3 reversible-form"  >
        {!! Form::open(['action'=>'GalleryTypeController@store','id'=>'gallery-type-form']) !!}
        ...
        <div class="row form-group mb-4">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    {!! Form::text('english_name',null,['class'=>'form-control','aria-required'=>"true" ,'aria-invalid'=>"false",'required','id'=>'english_name'])  !!}
                </div>
            </div>
        </div>
