...
<div  class="button-header mb-4 white-background p-3">
    <div class="row">
        <div class="col-md-12 reversible-text">                                
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),"usefulCategory/create") }}" class="red-button btn  pointer white-text"> 
                {{ Lang::get('headings.NewUsefulCategory')}}
            </a>
        </div>
    </div>
</div>
<div class="white-background content-details">                        
    <div class="content-header white-text">
        <h4 class="p-3 f16 f400 reversible-text"> {{Lang::get('headings.usefulCategories')}} </h4>
    ...
    <div class="p-3"  >
        <div class="row justify-content-end mb-4">
            ...
            <div class="col-md-3">
                <input type="text" name="search" class="form-control" id="usefulCategory_search" placeholder="{{Lang::get('headings.Search')}}">
            </div>
        </div>
        <div class="seacrch_usefulCategory_contrent"></div>
                    ...
                    <div class="table-responsive text-center">
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>                               
                                    <td> <?php echo $i ?></td>        
                                    <td>{{$usefulCategory->arabic_name}}</td>
                            
                                    <td>{{$usefulCategory->english_name}}</td>
                                   
                                    <td>
                                        @if($usefulCategory->active ==1)
                                        <i class="fa fa-check-circle active-item" aria-hidden="true"></i>
                                        @elseif ($usefulCategory->active ==0)
                                        <i class="fa fa-times red-text" aria-hidden="true"></i>
                                        @endif

                                    </td>
                                    <td>
                                        <i class="fa fa-trash-o tip pointer posdel remove" title="Remove" data-toggle="modal" data-target="#DeleteModal{{$usefulCategory->id}}" ></i>
                                    </td>
                                    <td>
                                        <i class="fa fa-pencil edit" aria-hidden="true"  title="edit" data-toggle="modal" data-target="#EditModal{{$usefulCategory->id}}">
                                        </i>
                                    </td>  
                                </tr>
                                <?php $i++; ?>
                        ...
                        @foreach($usefulCategories as $usefulCategory)  
                        <div class="modal fade" id="DeleteModal{{$usefulCategory->id}}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body"> 
                                        ...
                                        <div class="modal-footer border-none">
                                            {{ csrf_field()}}
                                            <button data-id="{{$usefulCategory->id}}" type="button"  class="btn actionBtn btn-danger usefulCategory-delete delete-button" data-dismiss="modal">
                        ...
                        @endforeach
                        @foreach($usefulCategories as $usefulCategory)  
                        <div class="modal fade" id="EditModal{{$usefulCategory->id}}" tabindex="-1" role="dialog" aria-labelledby="EditModalLabel" aria-hidden="true">
                            <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                    <div class="modal-header content-header white-text" >
                                        <div class="col-md-5 text-left reversible-text">
                                            <h4 class="pt-3 pb-3 pl-3 f16 f400"> {{Lang::get('headings.EditUsefulCategory')}} </h4>
                                        </div>
                                    ...
                                    {!! Form::model($usefulCategory ,['method'=>'PATCH','action'=>['UsefulCategoryController@update' ,$usefulCategory->id],'id'=>'usefulCategory-form']) !!}
                                    <div class="modal-body mt-3">
                                        <div class="row form-group mb-4">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group">                      
                                                    {!! Form::text('arabic_name',$usefulCategory->arabic_name,['class'=>'form-control','aria-required'=>"true" ,'aria-invalid'=>"false",'id'=>'arabic_name'])  !!}
                                                </div>
                                            </div>
                                        ...
                                        <div class="row form-group mb-4">
                                           <div class="col-md-3 reversible-text text-left  pl-4">
                                            ...
                                            <div class="col-md-3">
                                                <div class="input-group"> 
                                                     {!! Form::text('english_name',$usefulCategory->english_name,['class'=>'form-control','aria-required'=>"true" ,'aria-invalid'=>"false",'id'=>'english_name'])  !!}
