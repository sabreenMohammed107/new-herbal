...
<div  class="button-header mb-4 white-background p-3">
    <div class="row">
        <div class="col-md-12 reversible-text">                                
            <a href="{{ LaravelLocalization::getLocalizedURL(LaravelLocalization::getCurrentLocale(),"about/") }}" class="red-button btn  pointer white-text ">
...
<div class="white-background content-details">                        
    ...
    <div class="p-3 mt-3 reversible-form"  >
        {!! Form::open(['action'=>'AboutController@store','id'=>'about-form']) !!}
        ...
        <div class="row form-group mb-4">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    <textarea class='form-control' rows="3" name="arabic_value" id='arabic_value' required="" ></textarea>
                </div>
            </div>
        </div>
        <div class="row form-group mb-4">
            ...
            <div class="col-md-3">
                <div class="input-group">
                    <textarea class='form-control' rows="3" name="english_value" id='english_value' required="" ></textarea>
                </div>
            </div>
        </div>
