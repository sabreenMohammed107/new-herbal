            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="quote-sub-header">
                        {{ Html::image("images/leaf.png", 'alt text', array('class' => 'logo-leaf')) }}{{ Lang::get('headings.news')}}
                    </h2>                           
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-10">
                        <div class="row p-0">
                            ...
                            <div class="col-md-10 col-9">
                                {{ Html::image("images/$new->image", 'alt text', array('class' => 'img-fluid w100 event-image')) }}
