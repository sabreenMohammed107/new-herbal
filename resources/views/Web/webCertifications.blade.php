            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <h2 class="quote-sub-header">
                        ...
                        {{ Html::image("images/leaf.png", 'alt text', array('class' => 'logo-leaf')) }}{{ Lang::get('headings.certifications')}}
                    </h2>                           
                </div>
            </div>
        </div>
        ...
        <div class="container  pb-5 ">
            <div class="row">
                ...
                <div class="col-md-6 certificate-first-box mt-5">
                    {{ Html::image("images/Certification/$certification->image", 'alt text', array('class' => 'img-fluid certificate-image full-width')) }}
