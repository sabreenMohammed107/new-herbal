    ...
    <div class="container light-grey-bg event-detail custom-container">
        <div class="row p-0">
            <div class="col-md-12 p-0">
                <article>
                    {{ Html::image("images/News/$new->image", 'alt text', array('class' => 'img-fluid full-width event-detail-image')) }}
                </article><!--/#post-->
        ...
        <div class="row reversible-form" style="border-top: 1px solid #ccc;">
            ...
            <div class="col-md-4 p-5 col-12 col-sm-6">
                <div class="row text-center">
                    {{ Html::image("images/News/$itemNews->image", 'alt text', array('class' => 'full-width img-fluid related-product-imgae')) }}
