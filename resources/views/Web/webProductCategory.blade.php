            ...
            <div class="row">
                <div class="col-md-12 text-center ">
                    <h2 class="quote-sub-header">
                        {{ Html::image("public/images/leaf.png", 'alt text', array('class' => 'logo-leaf')) }}{{ Lang::get('headings.products')}}
                    </h2>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid pt-3 pb-3 ">
                ...
                <div class="col-md-12">
                    <div id="filters" class="filter-links">
                        ...
                        <button class="btn-filter green-active-background text-white  mb-2" data-filter="*">
                            {{ Html::image("public/images/ProductCategory/cub.jpg", 'alt text', array('class' => 'product-category-img')) }}
                        ...
                        <button class="btn-filter  mb-2 uppercase" data-filter=".{{$product_category->english_name}}">
                            {{ Html::image("public/images/ProductCategory/$product_category->image", 'alt text', array('class' => 'product-category-img')) }}
            ...
            <div class="text-center mt-2 mb-2">
                <form role="search" action="http://demo.virtuti.info/demonstrations/vt28/" method="get" id="searchform" class=" search-form">
                    ...
                    {{ Html::image("public/images/zoom1.png", 'alt text', array('class' => 'img-fluid img-seacrh')) }}
                </form>
            </div>
